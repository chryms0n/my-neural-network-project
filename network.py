...
class Network:
    ...
    def backprop(self, x, y):
        """
        Return a tuple of '(nabla_b, nabla_w)' representing
        ...
        # little differently to the notation in Chapter 2 of
        # the book. Here, l = 1 means the last layer of neurons,
        # l = 2 is the second last layer, and so on. It's a renumbering
        # of the scheme in the book, used here to take advantage of the
